...
public class MenuAquaponik extends Activity {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBeranda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(MenuAquaponik.this, btnBeranda);
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        ...
                        if (itemId == R.id.act1) {
                            Intent intent = new Intent(MenuAquaponik.this, MainActivity.class);
                            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                            startActivity(intent);
                            finish();
                            return true;
                        }else if (itemId == R.id.act2) {
                            Intent intent = new Intent(MenuAquaponik.this, MainMenu.class);
                            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                            startActivity(intent);
                            finish();
                            return true;
        ...
        btnKonfigurasiPinIOT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AquaKonfigurasiPin.class);
                startActivity(intent);
            }
        });
    ...
    public void showPopupTentangTanaman(View v){
        Button btnBack;
        myDialog.setContentView(R.layout.a_popup_tentang_tanaman);
    ...
    public void showPopUpImplementasiIOT(View v){
        Button btnBack;
        Button btnKameraAR;
        myDialog.setContentView(R.layout.a_popup_implementasi_iot);
        btnBack = myDialog.findViewById(R.id.btnBack);
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
